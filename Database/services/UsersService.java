...
public class UsersService {
	...
	public static void addUser(RegisteredUser user){
		//INSERT INTO users(userid, idnum, usertype, firstname, lastname, username, 
	...
	public static ArrayList<RegisteredUser> getAllUsers(){
		...
		String sql = "SELECT * FROM " + RegisteredUser.TABLE_NAME + " ORDER BY " + RegisteredUser.COLUMN_LASTNAME + " ASC";
	...
	public static ArrayList<RegisteredUser> getAllUsersByType(int usertype){
		ArrayList<RegisteredUser> userlist = new ArrayList<RegisteredUser>();
		...
		String sql = "SELECT * FROM " + RegisteredUser.TABLE_NAME + "WHERE " + RegisteredUser.COLUMN_USERTYPE 
				+ "= ? ORDER BY " + RegisteredUser.COLUMN_LASTNAME + " ASC";
