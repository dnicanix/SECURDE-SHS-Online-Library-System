        ...
        <div class="constructor">
            ...
            <div id = "div_readingmaterial" class = "row">
                <div id = "div_readingmaterialdetails" class = "col-md-11">
                     <p id = "title"> <a href = "#" id = "${reading.readingid}" name = "a_reading"> ${reading.readingtitle} </a>
            ...
            <fieldset class="fieldset_reviews" style = "max-width:1000px;">
                    ...
                    <div class = "col-md-5" style = "margin-left:-30px;">
                        <form>
                            <div class="form-group">
                                <label for="exampleTextarea">${user.firstname} + ${user.lastname}</label>
                                <textarea class="form-control" placeholder = "How's the reading material?" rows="3"></textarea>
                            </div>
               ...
               <c:forEach var = "c" items = "${reviews}" varStatus="loop"> 
                <div class = "row div_reviews">
                    ...
                    <div class = "col-md-5" style = "margin-left:-30px;">
                        <label id = "label_reviewer"> ${c.userid } </label> <label id = "label_reviewdate"> ${c.reviewdate }</label>
                        <p>${c.review} </p>
                    </div>
