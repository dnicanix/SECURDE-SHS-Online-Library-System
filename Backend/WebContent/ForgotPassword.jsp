    ...
    <div class = "container">
        <div class = "main-forgotpassword main-center">
           ...
           <div class = "row">
               ...
               <div class = "col-md-6">
                   <form id = "form_forgotpassword" action="ForgotPasswordServlet" method="POST">
                        ...
                        <button id = "button_forgotpassword" type="submit" class="btn btn-primary btn-sm"> <b> > > </b> </button> 
                   </form>
               </div>
           </div>
